...
const article = await readFile(
  `${root}/blog/carreira-mulheres-negras-fadiga-racial/index.html`,
  'utf8',
);
...
const postUrl =
  /assets(?:\/|\\u002F)content(?:\/|\\u002F)blog(?:\/|\\u002F)posts(?:\/|\\u002F)carreira-mulheres-negras-fadiga-racial\.json/g;
...
const structuredData = article.match(/<script id="json-ld-blog-post"[^>]*>([\s\S]*?)<\/script>/);
