...
test('exercises the production Nginx routing and header contract', async (t) => {
  if (!dockerAvailable()) {
  ...
  try {
    ...
    writeFileSync(join(containerRoot, 'blog/entry/index.html'), '<article><h1>entry</h1></article>');
