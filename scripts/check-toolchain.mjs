...
export const isSupportedToolchain = (nodeVersion, npmVersion) => {
  ...
  return compareVersions(node, [22, 22, 3]) === 0
    && compareVersions(npm, [10, 9, 9]) === 0;
};
...
if (import.meta.url === new URL(process.argv[1], 'file://').href) {
  ...
  if (!supported) {
    ...
    console.error(`Unsupported toolchain. Required Node.js 22.22.3 and npm 10.9.9; received Node.js ${process.versions.node} and npm ${npmMajor}.${npmMinor}.${npmPatch}.`);
    process.exit(1);
  }
}
