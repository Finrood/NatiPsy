...
for (const [name, template] of [['top-menu', topMenu], ['blog-list', blogList], ['blog-post', blogPost], ['blog-card', blogCard]]) {
...
assert.match(blogList, /<div class="block (?:h-48|relative aspect-\[2\/1\]) bg-gray-200 overflow-hidden" aria-hidden="true">[\s\S]*?\[ngSrc\]/,
