...
test('excludes heavy, generated, and secret-bearing local paths', () => {
  for (const required of ['.git', 'node_modules', 'dist', '.angular', 'coverage', '.env', '*.pem', '*.key']) {
...
test('does not exclude required application source and manifests', () => {
  for (const required of ['public', 'src', 'package.json', 'package-lock.json', 'Dockerfile', 'nginx.conf']) {
