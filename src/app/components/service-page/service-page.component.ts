...
export const SERVICE_PAGE_CONTENT = {
  therapyOnline: {
    ...
    metaDescription:
      'Conheça a terapia online com Natalia Ferreira, Psicóloga Clínica (CRP 12/19892), e veja como iniciar uma conversa sobre seu momento.',
    intro:
      'Um espaço de escuta, acolhimento e construção conjunta para olhar para sua experiência com mais clareza, respeitando seu contexto de vida e de relações.',
    sections: [
      {
  ...
  careerGuidance: {
    ...
    metaDescription:
      'Conheça a orientação profissional e de carreira com Natalia Ferreira e converse sobre transições, escolhas e próximos passos.',
    intro:
      'Um espaço para identificar caminhos, organizar perguntas e olhar para decisões profissionais com mais clareza, considerando sua história e seus objetivos.',
    sections: [
      {
...
export class ServicePageComponent implements OnInit, OnDestroy {
  ...
  readonly page: ServicePageContent =
    SERVICE_PAGE_CONTENT[this.route.snapshot.data['pageKey'] as ServicePageKey];
