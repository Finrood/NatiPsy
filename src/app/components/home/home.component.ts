  ...
  template: `
    <div class="bg-white min-h-screen relative">
      ...
      <a href="https://wa.me/+554884323764"
         ...
         class="fixed bottom-8 right-8 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition-colors duration-300 focus:outline-hidden focus:ring-2 focus:ring-green-400 focus:ring-offset-2 z-50">
