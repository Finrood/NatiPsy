    ...
    <article class="group bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 motion-safe:hover:scale-[1.03] flex flex-col">
      <div class="block relative aspect-[2/1] bg-gray-200 overflow-hidden" aria-hidden="true">
        @if (post.image) {
          ...
          <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-primary-pink/20 to-primary-blue/10" aria-hidden="true">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 text-gray-400" fill="none" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      ...
      <div class="p-6 flex flex-col flex-grow">
        <div class="flex items-center text-sm text-gray-500 mb-2">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
