        ...
        <div class="flex flex-col lg:flex-row gap-8 mb-12">
          ...
          <div class="lg:w-1/2 flex items-center">
            <picture>
              ...
              <img src="/assets/abordagem1.jpg" alt="Therapy approach image 1" class="w-full h-auto object-cover rounded-lg shadow-lg" loading="lazy" fetchpriority="low" width="600" height="400">
            </picture>
          </div>
        </div>
