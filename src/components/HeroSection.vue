  ...
  <section :id="id" class="min-h-screen bg-white text-primary-blue flex flex-col lg:flex-row items-center justify-center p-8 lg:p-16">
    ...
    <div class="relative w-full md:w-1/3 lg:w-1/3 mb-8 lg:mb-0 flex justify-center lg:justify-end">
      ...
      <div class="relative w-full h-auto rounded-3xl overflow-hidden shadow-xl z-20">
        <img src="../assets/NatiHero.png" alt="Natalia Ferreira, Psicóloga" class="w-full h-auto object-cover" width="400" height="600" loading="lazy" />
      </div>
    </div>
    ...
    <div class="w-full lg:w-2/3 lg:pl-16 flex flex-col items-center lg:items-start">
      ...
      <a
          ...
          class="inline-flex items-center bg-primary-blue text-white font-bold py-3 px-6 text-xl rounded-full shadow-lg hover:bg-opacity-90 transition duration-300 transform hover:scale-105"
  ...
  mounted() {
    useHead({
      ...
      meta: [
        ...
        { property: 'og:image', content: '@/assets/NatiHero.png' },
        ...
        { name: 'twitter:image', content: '@/assets/NatiHero.png' },
      ],
    })
  },
}
